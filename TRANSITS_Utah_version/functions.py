...
class Params(object):
    ...
    def calc_layers_nb(self):
        ...
        self.SN_final_nb = int(1/self.SN_set_thick)
...
class State(object):
    ...
    def __init__(self, p):
        ...
        # Build a snowpack of a given height (default is 1 m) with a layer number of p.SN_final_nb. Default value : 1000 layers
        ...
        for i in range(p.SN_final_nb+1):
            ...
            conc                 = 197. # ngNO3.g-1 (pit1=342 , pit2=391 , pit3=539 , pit4=197 , pit5=613 , pit6=495, pit7=186 , pit8=143, pit9=145, pit10=163, pit11=195, pit12=1072.4, orig=100 ngNO3/g) 
            self.SN_mass[i][0]   = conc * (p.M_N/p.M_NO3) * 1e-12 * p.SN_rho * ((p.SN_set_height/p.SN_final_nb) * p.cp_S) * 1000
            # Set d15N value in initial nitrate to 50 permil
            self.SN_d15N[i][0]   = 5 #(bottom pit value: pit1=2.2, pit2=3.0, pit3=2.4, pit4=5, pit5=3.4, pit6=2.4, pit7=-1.6, pit8=-4.3, pit9=-2.3, pit10=-0.81, pit11=0.8, pit12=7.5)
            # Set D17O value in initial nitrate to 30 permil   
            self.SN_D17O[i][0]   = 30
##        print '=== Initial conditions ==='
##        print 'Initial NO3- mass in snowpack ' + str(sum(self.SN_mass)) + ' kgN'
##        print 'Initial NO3- d15N in snowpack ' + str(sum(self.SN_mass*self.SN_d15N)) + ' kgN*permil'
##        print 'Initial NO3- D17O in snowpack ' + str(sum(self.SN_mass*self.SN_D17O)) + ' kgN*permil'
        self.AT_conc       = 6293. # ngNO3.m-3 
        ABL_height         = 60. # m
        self.AT_mass       = self.AT_conc * (1e-12) * (p.M_N/p.M_NO3) * (ABL_height* p.cp_S)
##        print 'Initial NO3- mass in AT ' + str(sum(self.AT_mass)) + ' kgN'
        self.AT_d15N       = 11.1 #(pit1=6.1, pit2=7.4, pit3=8.3, pit4=5.3, pit5=7.5, pit6=5.2, pit7=11.1, pit8=7.6, pit9=-5.52, pit10=7.6, pit11=7.6, pit12=7.4), #for new testing 
        #For self.AT_d15N, mean of snow d15Nvalues: (pit1=3.3, pit2=3.9, pit3=3.2, pit4=0.76, pit5=4.3, pit6=3.2, pit7=0.1, pit8=-1.8, pit9=-0.4, pit10=1.1, pit11=2.2, pit12=7.6)
        #For self.AT_d15N, max of snow d15Nvalues: (pit1=7.2, pit2=8.4, pit3=7.5, pit4=6.9, pit5=8.4, pit6=7.5, pit7=7.6, pit8=8.4, pit9=10, pit10=13, pit11=8.1, pit12=8.9)
        #For self.AT_d15N, min of snow d15Nvalues: (pit1=2.2, pit2=3, pit3=2.4, pit4=-7.9, pit5=3.4, pit6=2.4, pit7=-1.6, pit8=-4.3, pit9=-5.7, pit10=-3.7, pit11=0.8, pit12=6.3)
        self.AT_D17O       = 28.    
        self.FD_d15N       = self.AT_d15N
        self.FD_D17O       = self.AT_D17O
##        print 'Initial NO3- d15N in AT ' + str(sum(self.AT_mass*self.AT_d15N)) + ' kgN*permil'
##        print 'Initial NO3- D17O in AT ' + str(sum(self.AT_mass*self.AT_D17O)) + ' kgN*permil'
