# -*- coding: utf-8 -*-
"""
Created on Mon Nov  4 22:51:04 2024
...
# nc = Dataset('Glacial_simulation/Glacial_high_accu_1980_oz.nc','r')
# nc = Dataset('Glacial_simulation/Glacial_low_accu_1980_oz.nc','r')

# nc = Dataset('Holocene_simulation/Holocene_base_case_1980_oz.nc','r')
# nc = Dataset('Holocene_simulation/Holocene_high_accu_1980_oz.nc','r')
# nc = Dataset('Holocene_simulation/Holocene_low_accu_1980_oz.nc','r')

nc = Dataset('glacial_low_accu_80_1980_oz.nc','r')
...
# using the annual value in 7th year

# idx = 364: 416
FA_annual = FA_mass[364: 416].mean()*52*dt
FA_d15N_annual = (FA_mass[364: 416]*FA_d15N[364: 416]).sum()/FA_mass[260: 312].sum()
